...
<p align="center"><img src="https://user-images.githubusercontent.com/89768234/219297668-5a5df1b3-d467-4829-b071-d1652fd920b0.png" height="30%"></p>
...
### 예제 10-9 커리큘럼
#### 위상 정렬, 모든 강의를 수강하는 최소 시간

난이도가 많이 높다고 느껴졌다.      
위상 정렬인 것은 바로 알아볼 수 있었는데, 수강 시간의 계산에서 막혀 답안 예시를 봤다.       

처음에는 result[i] = max(result[i], result[q]+cost[i])가 왜 정답이 되는건지 이해가 안됬는데 result를 cost의 깊은복사를 진행하고 진입차수가 0인 노드를 진행 하면서 현재의 값과 지난 노드의 값+현재 노드의 초기 값을 계속해서 max로 갱신해줘야 한다는 것을 이해하기까지 너무 오래 걸렸었다.
